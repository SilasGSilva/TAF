...
import { DedDepen } from '../../../../../../models/labor-process-taxes.model';
import { OptionsAnswer } from '../../../../../../models/labor-process.model';
import { InfoCRIRRFValidations } from '../validations/infoCRIRRF-validations';
import { DedDepenView, DependentDeductionComponent } from './dependent-deduction.component';

describe(DependentDeductionComponent.name, () => {
  let fb: UntypedFormBuilder;

  let component: DependentDeductionComponent;
  
  beforeEach(() => {
    fb = new UntypedFormBuilder();

    component = new DependentDeductionComponent(fb);

    component.currentFormGroup = fb.group({
      dedDepen: fb.control(null),
    });
  ...
  describe('formArrayValue getter', () => {
    ...
    it('should return the value of the formArray', () => {
      const value = [{}, {}] as DedDepen[];
      component.currentFormGroup.get('dedDepen').patchValue(value);
  ...
  describe(DependentDeductionComponent.prototype.ngOnInit.name, () => {
    ...
    it('should transformRows when formArray changes', () => {
      ...
      component.ngOnInit();
      component.currentFormGroup.get('dedDepen').setValue([]);

      expect(component['transformRows']).toHaveBeenCalled();
    });
  });

  describe(DependentDeductionComponent.prototype.ngOnDestroy.name, () => {
  ...
  describe(DependentDeductionComponent.prototype.create.name, () => {
  ...
  describe(DependentDeductionComponent.prototype.save.name, () => {
  ...
  describe(DependentDeductionComponent.prototype.update.name, () => {
  ...
  describe(DependentDeductionComponent.prototype.cancel.name, () => {
    it('should close the form', () => {
      component.isSelected = true;
      component.editIndex = 1;
  ...
  describe(DependentDeductionComponent.prototype.handleClickEdit.name, () => {
    it('should set editIndex, open the form for editing, and set subFormGroup value', () => {
      const item = {} as DedDepenView;
      const clickIndex = 0;
    ...
    it('should open the form for editing item', () => {
      ...
      component.handleClickEdit({} as DedDepenView);
  ...
  describe(DependentDeductionComponent.prototype.handleClickDelete.name, () => {
    ...
    it('should close the form', () => {
      ...
      component.handleClickDelete({} as DedDepenView);
