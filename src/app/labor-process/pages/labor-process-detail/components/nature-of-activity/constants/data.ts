import { CodCategLabelEnum, CodCategEnum, NatAtividadeEnum, NatAtividadeLabelEnum } from '../../../../../../models/labor-process.model';
import { OptionalValuesFormatterUtils } from '../../../../../utils/optional-values-formatter-utils';

export const COLUMNS = [
  {
    label: 'Código',
    property: 'codCategLabel',
    width: '60%',
  },
  {
    label: 'Natureza da atividade',
    property: 'natAtividadeLabel',
    width: '20%',
  },
  {
    label: 'Data da mudança',
    property: 'dtMudCategAtiv',
    width: '20%',
    type: 'date',
  },
];
