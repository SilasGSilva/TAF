...
@Component({
  selector: 'app-validation-pending-table-detail',
  templateUrl: './validation-pending-table-detail.component.html',
  styleUrls: ['./validation-pending-table-detail.component.scss'],
  providers: [MasksPipe],
})
export class ValidationPendingTableDetailComponent implements OnInit {
  public literals = {};
  ...
  public loadData(): void {
    this.tableDetailsColumns = this.validationDetails(this.event);
    this.getItems();
  }
  ...
  public async getItems(): Promise<void> {
    ...
    this.tableDetailsService.getDetails(payload, 'validation').subscribe(
      response => {
  ...
  public validationDetails(event: string): Array<PoTableColumn> {
